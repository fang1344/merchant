  ...
  <div class="bluetooth-pop ui-pop-layout" :data-show="bluetoothPop">
       <div class="ui-pop-center">
           <div class="ui-pop-content">
                <button @click.native="turnOnBluetooth">打开蓝牙</button>
                <button type="primary" @click.native="getPairedDevices">已配对的设备</button>
                ...
                <div class="mt-20">
                  ...
                  <br>
                  <ul>
                    <li :key="index" v-for="(device,index) in pairedDevices">
                      名称：{{device.name}}<br> 地址：{{device.address}}
                      <br>
                      <button type="primary" @click.native="connDevice(device.address)">连接蓝牙</button>
                    </li>
                  </ul>
                </div>
      ...
      <div class="mt-20">
        ...
        <ul>
          <li v-for="device in newDevices">
            ...
            <button mini type="primary" @click.native="connDevice(device.address)">连接蓝牙</button>
          </li>
        </ul>
      </div>
      -->
...
export default {
  ...
  methods: {
     ...
     turnOnBluetooth: function() {
			 console.log(this.bluetoothTool);
