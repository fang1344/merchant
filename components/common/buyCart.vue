 <template>
    <section class="cart_module">
        <section v-if="!foods.specifications" class="cart_button">
            <transition name="showReduce">
                <span @click="removeOutCart(foods.category_id, foods.id, foods.id, foods.name, foods.price, '', foods.packing_fee, foods.goods_sku, foods.stock)" v-if="foodNum">
                    <svg>
            ...
            <svg class="add_icon" @touchstart="addToCart(foods.category_id, foods.id, foods.id, foods.name, foods.sale_price, '', foods.packing_fee, foods.goods_sku, foods.stock, $event)">
